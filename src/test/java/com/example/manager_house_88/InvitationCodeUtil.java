...
public class InvitationCodeUtil {
     ...
     */
    private static final char[] SERIALCODEDICT = new char[]{'q', 'w', '%', '8', 'a', '-', '2', 'd', '#', 'x', '9','o', 'c', '7', '_', '5', 'i', 'k', '3', 'm', 'j', 'u', 'f', 'r', '4', 'v', 'y', 'l', 't', 'n', '6', 'b', 'g', 'h'};
     ...
     * 全部字典
     */
    private static final char[] AllDICT = new char[]{'q', 'w', '%', '8', 'a', '-', '2', 'd', '#', 'x', '9','o', 'c', '7', '_', '5', 'i', 'k', '3', 'm', 'j', 'u', 'f', 'r', '4', 'v', 'y', 'l', 't', 'n', '6', 'b', 'g', 'h','s','z','$','e','p','0','1'};
     ...
     * 邀请码最小长度
     */
    private static final int SERIALCODELENGTH = 10;
